            ...
            fetch(this.props.session.ip+"/watchlist/is_auction_on_watchlist_for_xena_i_hope_it_works_lol", requestOptions)
                                    .then(async response => {
                                        ...
                                        if (!response.ok) {
                                           ...
                                           if(data==true){
                                            this.setState({ auctionOnWatchlist:true
                                            })
                                            
                                            
                                        }else{
                                                this.setState({auctionOnWatchlist:false})
                                            ...
                                            <div class="card" style={{marginBottom:"15px"}}>
                                                ...
                                                <div className="list-and-picture">
                                                    <ul className="list-group list-group-flush small-list-left">
                                                        ...
                                                        <li className="list-group-item">{(this.state.auction.item_type=="photo_album")?(<div><span
                                                            className="text-muted profile-list-annotation">Item type:</span><NavLink to="/photo-albums">photo_albums </NavLink></div>):
                                                            (<div><span
                                                            className="text-muted profile-list-annotation">Item type:</span><NavLink to={("/"+ this.state.auction.item_type)}>{this.state.auction.item_type}</NavLink></div>)}
                                                        </li>
                                                        <li className="list-group-item"><span
                                                ...
                                                <div className="list-and-picture">
                                                    <ul className="list-group list-group-flush small-list-left">
                                                    <li className="list-group-item"><span
                                                            className="text-muted profile-list-annotation">Name:</span><NavLink to={("/seller/id"+this.state.auction.seller_id)}>{this.state.seller.first_name+" "+this.state.seller.last_name}</NavLink>
                                                        </li>   
                                                        <li className="list-group-item"><span
                                            ...
                                            <div class="row">
                                                <div class="col" >
                                                    ...
                                                    <React.Fragment>
                                                        ...
                                                        <TransformComponent>   
                                                            <img   alt="profile_picture" style={{maxHeight: "300px", maxWidth:"500px"}} 
                                             ...
                                             <div>{this.state.auction.auction_type=="instant_sell"?(
                                                 <div>{(this.state.auction.unix_creation_time+7776000000)==(this.state.auction.unix_ending_time)?
                                                 (<div class="card" style={{marginBottom:"15px"}}>
                                                     <h5 class="card-header">Pricing</h5>
                                                     <div class="card-body" >
                                                         <div class="row mb-3">
                                                            <div className="col-md-6" style={{paddingLeft: "16px"}}><h5><strong>{this.state.auction.currency=="usd"?(<div>{this.state.auction.current_price+" $"}</div>):(<div>{this.state.auction.current_price+" €"}</div>)}</strong></h5></div></div>
                                                        <div class="row mb-3">
                                                            <div className="col-md-6" style={{paddingLeft: "16px"}}>
                                                            
                                                            <button type="button" class="btn btn-primary" onClick={event=>this.buyInstantSell(event)}>Buy now!</button>
                                                            
                                                                </div>
                                                                
                                                                <div style={{marginTop:"5px", marginLeft:"3px"}}>{ this.state.auctionOnWatchlist?(
                                                           ...
                                                           ):( <button className="btn btn-secondary" style={{marginTop:"5px", marginLeft:"3px"}} onClick={(event => this.addToWatchlist(event))}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                                                                <path d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                                               ...
                                               ( <div class="card" style={{marginBottom:"15px"}}>
                                                ...
                                                <div className="col-md-6" style={{marginLeft:"15px"}} >
                                                           <div>{ this.state.auctionOnWatchlist?(
                                                               <button className="btn btn-secondary" onClick={(event => this.removeFromWatchlist(event))}>
                                                               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                                                               <path d="M8 2.748l-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z"/>
                                                           </svg> Remove from watchlist </button>
                                             ...
                                             <div class="card" style={{marginBottom:"15px"}}>
                                                ...
                                                <div className="list-and-picture">
                                                    ...
                                                    <li className="list-group-item"><span
                                                       ...
                                                       <div> {this.state.seller.description=="" ? (
                                                            <div></div>
                                                        ) : (
                                                            <li className="list-group-item"><span
                                                            className="text-muted profile-list-annotation">Description:</span> {this.state.seller.description}</li>
                                                        )}</div>
                                                         <li className="list-group-item">
                                                            <form className="row g-12">
                                                            <div className="mb-12" style={{paddingLeft: "16px"}}>
                                                            <span
                                                                    className="text-muted profile-list-annotation">Contact seller:</span>
    ...
    async buyInstantSell(event){
        ...
        fetch(this.props.session.ip+"/auctions/bet", requestOptions)
            .then(async response => {
                ...
                {
                    alert("Buying didn't work");
                    console.log(this.props.session.key)
                }
                else if (!response.ok) {
                    //this.setState({error: nice_error})
                    alert("object is sold already")
                } else {
                    
                    alert("You bought the object successfully");
                    this.setState({instantSell:{sold:true,youWon:true}})
                }
            })
            .catch(error => {
                console.error('There was an error!', error);
